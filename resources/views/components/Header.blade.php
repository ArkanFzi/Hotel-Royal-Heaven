        ...
        <div class="relative z-50 flex justify-center w-full" style="margin-top: -60px;">
            <nav class="w-full max-w-3xl">
                <div class="flex gap-x-4 lg:gap-x-6 bg-white rounded-xl py-2 px-4 shadow-xl border-t-2 border-b-2 border-transparent justify-center"
                    ...
                    <a href="#" class="px-4 py-2 font-semibold text-yellow-600 border-b-4 border-yellow-500 transition duration-150 text-center">
                        Dashboard
                    </a>
                    
                    <a href="#" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition duration-150 text-center">Daftar Kamar</a>
                    <a href="#" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition duration-150 text-center">Pesan Kamar</a>
                    <a href="#" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition duration-150 text-center">Riwayat</a>
                    <a href="#" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition duration-150 text-center">About Us</a>
                </div>
            </nav>
        </div>
    </div>
