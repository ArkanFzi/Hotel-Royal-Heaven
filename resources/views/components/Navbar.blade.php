        ...
        <div class="relative z-50 flex justify-center w-full" style="margin-top: -60px;">
            <nav class="w-full max-w-3xl">
                <div class="flex gap-x-4 lg:gap-x-6 bg-white rounded-xl py-2 px-4 shadow-xl border-t-2 border-b-2 border-transparent justify-center"
                    ...
                    @if(!auth()->check())
                        {{-- Guest Navbar --}}
                        <a href="{{ route('home') }}" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition text-center">Dashboard</a>
                    ...
                    @else
                        ...
                        <a href="{{ route('member.pemesanan.my') }}" class="px-4 py-2 font-medium text-gray-900 hover:text-yellow-600 transition text-center">Riwayat</a>
